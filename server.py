...
def _format_photo(p):
    return {
        ...
        "links": {"download": p["links"]["download"], "html": p["links"]["html"]},
...
async def unsplash_search_photos(params: SearchPhotosInput) -> str:
    """Search Unsplash. For Baleares/Aura use Mediterranean context queries."""
    try:
        ...
        if not photos:
            return f"No photos for '{params.query}'."
